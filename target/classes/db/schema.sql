-- OnlineEducationPlatform - Database Schema (MySQL 8)
...
-- Videos (for online learning / playback)
...
-- Messages (simple direct messages) and Discussions (forum-style)
...
-- Simple activity log for statistics
